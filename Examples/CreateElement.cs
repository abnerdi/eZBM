...
namespace eZBM.Examples
{
    class CreateElement
    {
        ...
        public static void CellAndSharedCell(string unparsed)
        {
            ...
            Matrix3d rMatrix = app.Matrix3dIdentity();
            CellElement oCell = app.CreateCellElement2("DECID",
                ref origin, ref scale, true, ref rMatrix);
            oCell.Color = 0;
            ...
            for (int x = 4; x <= 8; x += 2)
            {
                ...
                oSC = app.CreateSharedCellElement2("NORTH", ref
                    origin, ref scale, true, ref rMatrix);
        ...
        public static void LinearAndAngularDimension(string unparsed)
        {
            ...
            ds.AnglePrecision =
                MsdDimValueAnglePrecision.DimValueAnglePrecision1Place;
        ...
        public static void ConeAndBsplineSurface(string unparsed)
        {
            ...
            oBsplineSurface.FromCrossSections(ref aCurves,
                MsdBsplineSurfaceDirection.V, 4, true, true);
